  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeTab === 'summary' && <SummaryView intelligence={intelligence} />}
...
function SummaryView({ intelligence }: { intelligence: LogisticsIntelligence | null }) {
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-neutral-800 bg-neutral-900/30">
              ...
              <th className="p-4 text-[10px] font-mono text-neutral-500 uppercase tracking-widest">Lead Time</th>
          ...
          <tbody>
            {intelligence.deliverySchedule.map((item, idx) => (
              <tr key={idx} className="border-b border-neutral-800/50 hover:bg-neutral-800/30 transition-colors">
                ...
                <td className="p-4 text-xs text-neutral-400 font-mono">{item.leadTime} Days</td>
                <td className="p-4">
                  <div className="flex items-center gap-2">
...
// Helper Components
function StatCard({ label, value, subValue, icon: Icon, trend, trendUp, color = "text-white" }: any) {
  return (
    <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-3xl hover:border-emerald-500/30 transition-all group">
